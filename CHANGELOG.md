...
- Stopped the wallet picker from fetching announcement-controlled icon URLs by rendering only image data URIs or fallback initials [#49].
...
[#49]: https://github.com/dusk-network/connect/issues/49
