import type { AccountId, Address, BalanceResult, ChainId, DuskProvider, DuskProviderEventMap, DuskWalletState, SendTransactionParams, SwitchChainParams, TxResult } from "./types.js";
